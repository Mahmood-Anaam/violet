...
import tempfile
import re
from violet.utils.light_normalizer import light_normalizer
class PTBTokenizer(object):
    ...
    def tokenize(cls, corpus):
      ...
      #  token_lines = sentences.decode()
        tokenizer = light_normalizer()
        sentences_clean = tokenizer.run_light_normalizer(sentences)
        #sentences_clean2 = re.sub(r'[^\w\s]','',sentences)
        lines = sentences_clean.split('\n')
        #lines2 = sentences_clean2.split('\n')
        # remove temp file
